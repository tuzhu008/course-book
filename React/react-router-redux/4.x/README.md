...
react-router-redux 将与react-router长期相伴。 事实上，它已经在那里建立起来了。 [去看一看!](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-redux)

**这个 repo 是针对react-router-redux 4.x, 它只与react-router 2.x and 3.x兼容**

下一个版本的react-router-redux将是5.0.0，并且将与react-router4.x兼容。目前正在积极开发 [在这里](https://github.com/ReactTraining/react-router/tree/master/packages/react-router-redux). 请随意帮忙！
